...
const firstContentAlias = (note) => {
  ...
  if (!line) return "";
  return line.replace(/^#{1,6}\s+/, "").replace(/^[-*+]\s+/, "").replace(/^\d+\.\s+/, "").replace(/^\[\[([^\]\n]+?)\]\]$/, "$1").trim();
};
...
const buildGraph = (notes) => {
  ...
  const ghostByKey = /* @__PURE__ */ new Map();
  ...
  notes.forEach((n) => {
    ...
    const seenInThisNote = /* @__PURE__ */ new Set();
  ...
  const adj = Array.from({ length: validNodes.length }, () => /* @__PURE__ */ new Set());
  edges.forEach(([a, b]) => {
    degree[a]++;
    degree[b]++;
    adj[a].add(b);
...
const GraphView = () => {
  ...
  const graph = useMemo(() => {
    ...
    if (focusMode === "neighbors" && selectedNoteId) {
      ...
      if (startIdx >= 0) {
        const set = /* @__PURE__ */ new Set([startIdx]);
    ...
    if (hideOrphans || allowed || !showGhosts) {
      ...
      const adj = Array.from({ length: nodes.length }, () => /* @__PURE__ */ new Set());
      edges.forEach(([a, b]) => {
        degree[a]++;
        degree[b]++;
        adj[a].add(b);
  ...
  const getEdgeDash = (a, b) => graph.nodes[a]?.isGhost || graph.nodes[b]?.isGhost ? "4 4" : void 0;
  ...
  return /* @__PURE__ */ React.createElement(Box, { sx: { position: "relative", width: "100%", height: "100%", overflow: "hidden", bgcolor: "background.default" } }, /* @__PURE__ */ React.createElement(Box, { sx: { position: "absolute", top: 12, left: 16, zIndex: 2, display: "flex", alignItems: "center", gap: 1 } }, /* @__PURE__ */ React.createElement(HubIcon, { sx: { color: "primary.main", fontSize: 18 } }), /* @__PURE__ */ React.createElement(Typography, { variant: "subtitle2", sx: { fontWeight: 700 } }, "\u77E5\u8BC6\u56FE\u8C31"), /* @__PURE__ */ React.createElement(Chip, { size: "small", label: `${realNodeCount} \u7B14\u8BB0`, sx: { height: 22, fontSize: 11 } }), /* @__PURE__ */ React.createElement(Chip, { size: "small", label: `${graph.edges.length} \u94FE\u63A5`, sx: { height: 22, fontSize: 11 } }), ghostNodeCount > 0 && /* @__PURE__ */ React.createElement(
    Chip,
    {
      size: "small",
  ...
  ), noTitleCount > 0 && /* @__PURE__ */ React.createElement(
    Chip,
    {
      size: "small",
  ...
  ), hoverIdx >= 0 && graph.nodes[hoverIdx] && /* @__PURE__ */ React.createElement(
    Chip,
    {
      size: "small",
      color: "primary",
      variant: "outlined",
      label: `${graph.nodes[hoverIdx].title} \xB7 \u5EA6 ${graph.degree[hoverIdx]}`,
      sx: { height: 22, fontSize: 11, maxWidth: 320 }
    }
  )), /* @__PURE__ */ React.createElement(Box, { sx: { position: "absolute", top: 8, right: 12, zIndex: 2, display: "flex", alignItems: "center", gap: 0.75 } }, /* @__PURE__ */ React.createElement(
    TextField,
    {
      size: "small",
      value: search,
      ...
      slotProps: {
        input: {
          startAdornment: /* @__PURE__ */ React.createElement(InputAdornment, { position: "start" }, /* @__PURE__ */ React.createElement(SearchIcon, { sx: { fontSize: 16, color: "text.disabled" } }))
        }
      }
    }
    ...
    /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { fontWeight: 700, color: "text.primary" } }, "\u89C6\u56FE"), /* @__PURE__ */ React.createElement(
      ToggleButtonGroup,
      {
        size: "small",
        value: focusMode,
      ...
      /* @__PURE__ */ React.createElement(ToggleButton, { value: "all" }, "\u5168\u90E8"),
      /* @__PURE__ */ React.createElement(ToggleButton, { value: "neighbors", disabled: selectedIdx < 0 }, "\u90BB\u5C45")
    )),
    /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { color: "text.secondary" } }, "\u9690\u85CF\u5B64\u7ACB\u8282\u70B9"), /* @__PURE__ */ React.createElement(
      ToggleButton,
      {
        size: "small",
        value: "check",
    ...
    /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", alignItems: "center", justifyContent: "space-between" } }, /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { color: "text.secondary" } }, "\u663E\u793A\u672A\u89E3\u6790\u8282\u70B9"), /* @__PURE__ */ React.createElement(
      ToggleButton,
      {
        size: "small",
        value: "check",
    ...
    /* @__PURE__ */ React.createElement(Box, { sx: { display: "flex", alignItems: "center", gap: 0.5, mt: 0.25, color: "text.disabled" } }, /* @__PURE__ */ React.createElement(CategoryIcon, { sx: { fontSize: 13 } }), /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { fontSize: 10.5 } }, "\u70B9\u51FB\u951A\u5B9A \xB7 \u53CC\u51FB\u8DF3\u8F6C/\u65B0\u5EFA \xB7 \u62D6\u62FD\u8282\u70B9 \xB7 \u6EDA\u8F6E\u7F29\u653E")),
    /* @__PURE__ */ React.createElement(Box, { sx: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 0.75, pt: 0.25 } }, [
    ...
    ].map(([label, dash, color]) => /* @__PURE__ */ React.createElement(Box, { key: label, sx: { display: "flex", alignItems: "center", gap: 0.5, minWidth: 0 } }, /* @__PURE__ */ React.createElement(
      Box,
      {
        component: "span",
        sx: {
    ...
    ), /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { color: "text.disabled", fontSize: 10.5 } }, label))))
  ), /* @__PURE__ */ React.createElement(Box, { ref: containerRef, sx: { position: "absolute", inset: 0 } }, graph.nodes.length === 0 ? /* @__PURE__ */ React.createElement(Box, { sx: { height: "100%", display: "flex", alignItems: "center", justifyContent: "center", color: "text.secondary" } }, /* @__PURE__ */ React.createElement(Typography, { variant: "body2" }, focusMode === "neighbors" ? '\u5F53\u524D\u7B14\u8BB0\u6CA1\u6709\u90BB\u5C45\uFF0C\u5207\u6362\u5230"\u5168\u90E8"\u770B\u770B' : hideOrphans ? "\u6CA1\u6709\u4EFB\u4F55\u5E26\u94FE\u63A5\u7684\u7B14\u8BB0\uFF0C\u5199\u4E24\u6761 [[xxx]] \u8BD5\u8BD5" : "\u8FD8\u6CA1\u6709\u4EFB\u4F55\u7B14\u8BB0\uFF0C\u5199\u4E24\u6761 [[xxx]] \u8BD5\u8BD5")) : positions.length === graph.nodes.length ? /* @__PURE__ */ React.createElement(React.Fragment, null, graph.edges.length === 0 && /* @__PURE__ */ React.createElement(
    Box,
    {
      sx: {
        position: "absolute",
    ...
    /* @__PURE__ */ React.createElement(Typography, { variant: "body2", sx: { fontWeight: 700, mb: 0.25 } }, "\u8FD8\u6CA1\u6709\u68C0\u6D4B\u5230\u56FE\u8C31\u8FDE\u63A5"),
    /* @__PURE__ */ React.createElement(Typography, { variant: "caption", sx: { color: "text.secondary" } }, "\u5728\u7B14\u8BB0\u4E2D\u5199\u5165 [[\u7B14\u8BB0\u540D]] \u540E\uFF0C\u8FD9\u91CC\u4F1A\u663E\u793A\u5F15\u7528\u8FB9\uFF1B\u672A\u521B\u5EFA\u7684\u76EE\u6807\u4F1A\u663E\u793A\u4E3A\u865A\u7EBF\u5E7D\u7075\u8282\u70B9\u3002")
    ...
    /* @__PURE__ */ React.createElement("defs", null, /* @__PURE__ */ React.createElement("radialGradient", { id: "node-glow", cx: "50%", cy: "50%", r: "50%" }, /* @__PURE__ */ React.createElement("stop", { offset: "0%", stopColor: palette.primary.main, stopOpacity: "0.45" }), /* @__PURE__ */ React.createElement("stop", { offset: "100%", stopColor: palette.primary.main, stopOpacity: "0" }))),
    /* @__PURE__ */ React.createElement("g", { transform: `translate(${transform.tx}, ${transform.ty}) scale(${transform.s})` }, /* @__PURE__ */ React.createElement("g", null, graph.edges.map(([a, b], i) => {
    ...
    })), /* @__PURE__ */ React.createElement("g", null, graph.nodes.map((node, idx) => {
      ...
      return /* @__PURE__ */ React.createElement(
        ...
        isHi && /* @__PURE__ */ React.createElement(
          "circle",
          {
            r: r * 2.4,
            fill: "url(#node-glow)",
        ...
        pulseIdx === idx && /* @__PURE__ */ React.createElement(
          "circle",
          {
            r: r * 1.1,
            fill: "none",
          ...
          /* @__PURE__ */ React.createElement("animate", { attributeName: "r", from: r * 1.1, to: r * 3.3, dur: "520ms", fill: "freeze" }),
          /* @__PURE__ */ React.createElement("animate", { attributeName: "opacity", from: "0.48", to: "0", dur: "520ms", fill: "freeze" })
        ),
        /* @__PURE__ */ React.createElement(
          "circle",
          {
            ...
            strokeDasharray: getNodeStrokeDash(idx) || void 0,
            opacity: a
          }
        ),
        labelVisible(idx) && /* @__PURE__ */ React.createElement(
          "text",
          {
            x: r + 5,
            y: 4,
